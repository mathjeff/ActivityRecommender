...
namespace ActivityRecommendation.View
{
    public class FeatureOverviewLayout
    {
        public static LayoutChoice_Set New(LayoutStack layoutStack)
        {
            ...
            menuBuilder.AddLayout("Makes life more fun, right away", (new MenuLayoutBuilder(layoutStack))
            ...
            menuBuilder.AddLayout("Helps make life more meaningful", new MenuLayoutBuilder(layoutStack)
            ...
            menuBuilder.AddLayout("All for free", (new MenuLayoutBuilder(layoutStack))

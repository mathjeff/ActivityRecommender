...
namespace ActivityRecommendation.View
{
    public class FeatureOverviewLayout
    {
        public static LayoutChoice_Set New(LayoutStack layoutStack)
        {
            ...
            MenuLayoutBuilder convenientLayout_builder = new MenuLayoutBuilder(layoutStack);
            convenientLayout_builder.AddLayout("Fast UI with lots of autocomplete", (new HelpWindowBuilder())
                ...
                .Build());
            convenientLayout_builder.AddLayout("Personalized", (new HelpWindowBuilder())
                ...
                .Build());
            convenientLayout_builder.AddLayout("Provides suggestions", (new HelpWindowBuilder())
            ...
            benevolentLayoutBuilder.AddLayout("No fees or ads", (new HelpWindowBuilder())
                ...
                .Build());
            benevolentLayoutBuilder.AddLayout("Maximizes longterm happiness", (new HelpWindowBuilder())
            ...
            benevolentLayoutBuilder.AddLayout("All runs on the device", (new HelpWindowBuilder())
                ...
                .Build());
            menuBuilder.AddLayout("Has your best interests at heart", benevolentLayoutBuilder.Build());

            MenuLayoutBuilder smartLayout_builder = new MenuLayoutBuilder(layoutStack);
            smartLayout_builder.AddLayout("Fast feedback", (new HelpWindowBuilder())
                ...
                .Build());
            smartLayout_builder.AddLayout("Meaningful relative ratings", (new HelpWindowBuilder())
                ...
                .Build());
            smartLayout_builder.AddLayout("Measures your efficiency", (new HelpWindowBuilder())
                ...
                .Build());
            smartLayout_builder.AddLayout("You define what to optimize", (new HelpWindowBuilder())
                ...
                .Build());
            smartLayout_builder.AddLayout("Open source", new Vertical_GridLayout_Builder()
                ...
                .Build());
            menuBuilder.AddLayout("Smart and configurable", smartLayout_builder.Build());

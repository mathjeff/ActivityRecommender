...
// the ActivityRecommendor class is the main class that connects the user-interface to the Engine
namespace ActivityRecommendation
{
    class ActivityRecommendor
    {
        public ActivityRecommendor(Window newMainWindow)
        {
        ...
        {
            String titleString = "Activity Recommendor By Jeff Gaston.";
            titleString += "Build Date: 2011-12-12T15:21:00";
            this.mainDisplay = new TitledControl(titleString);
            this.mainDisplayGrid = new DisplayGrid(1, 3);

...
namespace ActivityRecommendation
{
    public class RatingSummarizer
    {
        ...
        // The weight of the resultant distribution is adjusted so that any date equal to referenceDate has weight equal to 1
        public Distribution GetValueDistributionForDates(DateTime referenceDate, DateTime startDate, DateTime endDate)
        {
